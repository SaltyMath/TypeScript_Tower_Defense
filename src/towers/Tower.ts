...
export class Tower {
    ...
    getDirectionRow(target: Vec2) {
        ...
        if (degrees >= -157.5 && degrees < -112.5) return 7;
        if (degrees >= -112.5 && degrees < -67.5) return 6;
        if (degrees >= -67.5 && degrees < -22.5) return 5;
        if (degrees >= -22.5 && degrees < 22.5) return 4;
        if (degrees >= 22.5 && degrees < 67.5) return 3;
        if (degrees >= 67.5 && degrees < 112.5) return 2;
        if (degrees >= 112.5 && degrees < 157.5) return 1;
